...
/**
 * Maps to elcm.lkp_approval_decision -- generated from the authoritative dodaso-platform.dbs
 ...
 */
@Entity
@Table(name = "lkp_approval_decision")
@Getter
@Setter
public class LkpApprovalDecision implements Serializable {
