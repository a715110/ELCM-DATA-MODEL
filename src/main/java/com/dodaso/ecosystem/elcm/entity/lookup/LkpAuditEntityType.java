...
/**
 * Maps to elcm.lkp_audit_entity_type -- generated from the authoritative dodaso-platform.dbs
 ...
 */
@Entity
@Table(name = "lkp_audit_entity_type")
@Getter
@Setter
public class LkpAuditEntityType implements Serializable {
