package com.dodaso.ecosystem.elcm.entity.lookup;
...
/**
 * Maps to elcm.lkp_confidence_tier -- generated from the authoritative dodaso-platform.dbs
 ...
 */
@Entity
@Table(name = "lkp_confidence_tier")
@Getter
@Setter
public class LkpConfidenceTier implements Serializable {
    ...
    @Column(name = "min_confidence_pct")
    private BigDecimal minConfidencePct;

    @Column(name = "max_confidence_pct")
    private BigDecimal maxConfidencePct;
