...
/**
 * Maps to elcm.lkp_audit_event_type -- generated from the authoritative dodaso-platform.dbs
 ...
 */
@Entity
@Table(name = "lkp_audit_event_type")
@Getter
@Setter
public class LkpAuditEventType implements Serializable {
