...
/**
 * Maps to elcm.lkp_document_role -- generated from the authoritative dodaso-platform.dbs
 ...
 */
@Entity
@Table(name = "lkp_document_role")
@Getter
@Setter
public class LkpDocumentRole implements Serializable {
