...
/**
 * Maps to elcm.lkp_extraction_job_status -- generated from the authoritative dodaso-platform.dbs
 ...
 */
@Entity
@Table(name = "lkp_extraction_job_status")
@Getter
@Setter
public class LkpExtractionJobStatus implements Serializable {
