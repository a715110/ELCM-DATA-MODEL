...
/**
 * Maps to elcm.lkp_submission_status -- generated from the authoritative dodaso-platform.dbs
 ...
 */
@Entity
@Table(name = "lkp_submission_status")
@Getter
@Setter
public class LkpSubmissionStatus implements Serializable {
