...
/**
 * Maps to elcm.lkp_contract_type -- generated from the authoritative dodaso-platform.dbs
 ...
 */
@Entity
@Table(name = "lkp_contract_type")
@Getter
@Setter
public class LkpContractType implements Serializable {
