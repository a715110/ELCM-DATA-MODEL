...
/**
 * Maps to elcm.extraction_template -- generated from the authoritative dodaso-platform.dbs
 ...
 */
@Entity
@Table(name = "extraction_template", uniqueConstraints = {@UniqueConstraint(columnNames = {"name", "version"})})
@Getter
@Setter
public class ExtractionTemplate implements Serializable {
