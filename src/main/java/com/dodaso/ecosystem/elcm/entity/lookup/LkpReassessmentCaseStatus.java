...
/**
 * Maps to elcm.lkp_reassessment_case_status -- generated from the authoritative dodaso-platform.dbs
 ...
 */
@Entity
@Table(name = "lkp_reassessment_case_status")
@Getter
@Setter
public class LkpReassessmentCaseStatus implements Serializable {
