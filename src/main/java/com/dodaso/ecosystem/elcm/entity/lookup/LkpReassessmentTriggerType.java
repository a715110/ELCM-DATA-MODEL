...
/**
 * Maps to elcm.lkp_reassessment_trigger_type -- generated from the authoritative dodaso-platform.dbs
 ...
 */
@Entity
@Table(name = "lkp_reassessment_trigger_type")
@Getter
@Setter
public class LkpReassessmentTriggerType implements Serializable {
