...
/**
 * Maps to elcm.lkp_contract_record_relationship_type -- generated from the authoritative dodaso-platform.dbs
 ...
 */
@Entity
@Table(name = "lkp_contract_record_relationship_type")
@Getter
@Setter
public class LkpContractRecordRelationshipType implements Serializable {
