...
/**
 * Maps to elcm.lkp_package_status -- generated from the authoritative dodaso-platform.dbs
 ...
 */
@Entity
@Table(name = "lkp_package_status")
@Getter
@Setter
public class LkpPackageStatus implements Serializable {
