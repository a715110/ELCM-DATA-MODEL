...
/**
 * Maps to elcm.lkp_staged_document_status -- generated from the authoritative dodaso-platform.dbs
 ...
 */
@Entity
@Table(name = "lkp_staged_document_status")
@Getter
@Setter
public class LkpStagedDocumentStatus implements Serializable {
