...
/**
 * Maps to elcm.lkp_reassessment_outcome -- generated from the authoritative dodaso-platform.dbs
 ...
 */
@Entity
@Table(name = "lkp_reassessment_outcome")
@Getter
@Setter
public class LkpReassessmentOutcome implements Serializable {
