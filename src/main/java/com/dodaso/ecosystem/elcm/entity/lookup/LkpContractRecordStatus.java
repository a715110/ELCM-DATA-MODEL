...
/**
 * Maps to elcm.lkp_contract_record_status -- generated from the authoritative dodaso-platform.dbs
 ...
 */
@Entity
@Table(name = "lkp_contract_record_status")
@Getter
@Setter
public class LkpContractRecordStatus implements Serializable {
