...
/**
 * Maps to elcm.lkp_routing_intent -- generated from the authoritative dodaso-platform.dbs
 ...
 */
@Entity
@Table(name = "lkp_routing_intent")
@Getter
@Setter
public class LkpRoutingIntent implements Serializable {
