...
/**
 * DTO for the elcm LkpFieldDataType entity/table. Mirrors the JPA entity's persisted
 ...
 * convention. Instances are placed into the matching LkpFieldDataTypeDTOContainer
 * before being passed to/from the service layer.
 */
@Getter
@Setter
public class LkpFieldDataTypeDTO extends BaseDTO implements Serializable {
