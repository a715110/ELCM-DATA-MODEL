...
/**
 * DTO for the elcm LkpAuditEntityType entity/table. Mirrors the JPA entity's persisted
 ...
 * convention. Instances are placed into the matching LkpAuditEntityTypeDTOContainer
 * before being passed to/from the service layer.
 */
@Getter
@Setter
public class LkpAuditEntityTypeDTO extends BaseDTO implements Serializable {
