...
/**
 * DTO for the elcm LkpStagedDocumentStatus entity/table. Mirrors the JPA entity's persisted
 ...
 * convention. Instances are placed into the matching LkpStagedDocumentStatusDTOContainer
 * before being passed to/from the service layer.
 */
@Getter
@Setter
public class LkpStagedDocumentStatusDTO extends BaseDTO implements Serializable {
