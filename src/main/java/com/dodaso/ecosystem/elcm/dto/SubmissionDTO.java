...
/**
 * DTO for the elcm Submission entity/table. Mirrors the JPA entity's persisted
 ...
 * convention. Instances are placed into the matching SubmissionDTOContainer
 * before being passed to/from the service layer.
 */
@Getter
@Setter
public class SubmissionDTO extends BaseDTO implements Serializable {
  ...
  private LkpSubmissionStatusDTO statusDTO;
