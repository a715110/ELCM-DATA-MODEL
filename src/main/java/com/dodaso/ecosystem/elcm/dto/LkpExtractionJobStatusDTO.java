...
/**
 * DTO for the elcm LkpExtractionJobStatus entity/table. Mirrors the JPA entity's persisted
 ...
 * convention. Instances are placed into the matching LkpExtractionJobStatusDTOContainer
 * before being passed to/from the service layer.
 */
@Getter
@Setter
public class LkpExtractionJobStatusDTO extends BaseDTO implements Serializable {
