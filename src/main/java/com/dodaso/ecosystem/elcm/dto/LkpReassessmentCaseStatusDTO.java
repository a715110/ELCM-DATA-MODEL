...
/**
 * DTO for the elcm LkpReassessmentCaseStatus entity/table. Mirrors the JPA entity's persisted
 ...
 * convention. Instances are placed into the matching LkpReassessmentCaseStatusDTOContainer
 * before being passed to/from the service layer.
 */
@Getter
@Setter
public class LkpReassessmentCaseStatusDTO extends BaseDTO implements Serializable {
