...
/**
 * DTO for the elcm ExtractionTemplateField entity/table. Mirrors the JPA entity's persisted
 ...
 * convention. Instances are placed into the matching ExtractionTemplateFieldDTOContainer
 * before being passed to/from the service layer.
 */
@Getter
@Setter
public class ExtractionTemplateFieldDTO extends BaseDTO implements Serializable {
  ...
  private LkpFieldDataTypeDTO dataTypeDTO;
