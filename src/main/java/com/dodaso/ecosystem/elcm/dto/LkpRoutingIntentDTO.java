...
/**
 * DTO for the elcm LkpRoutingIntent entity/table. Mirrors the JPA entity's persisted
 ...
 * convention. Instances are placed into the matching LkpRoutingIntentDTOContainer
 * before being passed to/from the service layer.
 */
@Getter
@Setter
public class LkpRoutingIntentDTO extends BaseDTO implements Serializable {
