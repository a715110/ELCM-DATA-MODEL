...
/**
 * DTO for the elcm Workspace entity/table. Mirrors the JPA entity's persisted
 ...
 * convention. Instances are placed into the matching WorkspaceDTOContainer
 * before being passed to/from the service layer.
 */
@Getter
@Setter
public class WorkspaceDTO extends BaseDTO implements Serializable {
