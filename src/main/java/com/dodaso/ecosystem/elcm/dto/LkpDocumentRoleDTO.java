...
/**
 * DTO for the elcm LkpDocumentRole entity/table. Mirrors the JPA entity's persisted
 ...
 * convention. Instances are placed into the matching LkpDocumentRoleDTOContainer
 * before being passed to/from the service layer.
 */
@Getter
@Setter
public class LkpDocumentRoleDTO extends BaseDTO implements Serializable {
