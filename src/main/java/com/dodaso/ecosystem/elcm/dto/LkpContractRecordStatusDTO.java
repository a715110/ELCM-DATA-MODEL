...
/**
 * DTO for the elcm LkpContractRecordStatus entity/table. Mirrors the JPA entity's persisted
 ...
 * convention. Instances are placed into the matching LkpContractRecordStatusDTOContainer
 * before being passed to/from the service layer.
 */
@Getter
@Setter
public class LkpContractRecordStatusDTO extends BaseDTO implements Serializable {
