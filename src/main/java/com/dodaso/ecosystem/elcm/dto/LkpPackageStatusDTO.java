...
/**
 * DTO for the elcm LkpPackageStatus entity/table. Mirrors the JPA entity's persisted
 ...
 * convention. Instances are placed into the matching LkpPackageStatusDTOContainer
 * before being passed to/from the service layer.
 */
@Getter
@Setter
public class LkpPackageStatusDTO extends BaseDTO implements Serializable {
