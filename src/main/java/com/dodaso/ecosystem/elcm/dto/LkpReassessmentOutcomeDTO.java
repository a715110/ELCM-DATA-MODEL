...
/**
 * DTO for the elcm LkpReassessmentOutcome entity/table. Mirrors the JPA entity's persisted
 ...
 * convention. Instances are placed into the matching LkpReassessmentOutcomeDTOContainer
 * before being passed to/from the service layer.
 */
@Getter
@Setter
public class LkpReassessmentOutcomeDTO extends BaseDTO implements Serializable {
