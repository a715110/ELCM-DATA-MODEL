...
/**
 * DTO for the elcm LkpContractType entity/table. Mirrors the JPA entity's persisted
 ...
 * convention. Instances are placed into the matching LkpContractTypeDTOContainer
 * before being passed to/from the service layer.
 */
@Getter
@Setter
public class LkpContractTypeDTO extends BaseDTO implements Serializable {
