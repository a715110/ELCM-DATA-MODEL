...
/**
 * DTO for the elcm LkpApprovalDecision entity/table. Mirrors the JPA entity's persisted
 ...
 * convention. Instances are placed into the matching LkpApprovalDecisionDTOContainer
 * before being passed to/from the service layer.
 */
@Getter
@Setter
public class LkpApprovalDecisionDTO extends BaseDTO implements Serializable {
