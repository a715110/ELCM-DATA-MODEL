...
/**
 * DTO for the elcm ReassessmentSurveyResponse entity/table. Mirrors the JPA entity's persisted
 ...
 * convention. Instances are placed into the matching ReassessmentSurveyResponseDTOContainer
 * before being passed to/from the service layer.
 */
@Getter
@Setter
public class ReassessmentSurveyResponseDTO extends BaseDTO implements Serializable {
