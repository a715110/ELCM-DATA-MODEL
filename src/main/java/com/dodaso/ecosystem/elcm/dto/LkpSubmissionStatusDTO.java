...
/**
 * DTO for the elcm LkpSubmissionStatus entity/table. Mirrors the JPA entity's persisted
 ...
 * convention. Instances are placed into the matching LkpSubmissionStatusDTOContainer
 * before being passed to/from the service layer.
 */
@Getter
@Setter
public class LkpSubmissionStatusDTO extends BaseDTO implements Serializable {
