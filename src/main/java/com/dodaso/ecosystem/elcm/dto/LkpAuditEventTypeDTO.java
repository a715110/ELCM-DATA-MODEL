...
/**
 * DTO for the elcm LkpAuditEventType entity/table. Mirrors the JPA entity's persisted
 ...
 * convention. Instances are placed into the matching LkpAuditEventTypeDTOContainer
 * before being passed to/from the service layer.
 */
@Getter
@Setter
public class LkpAuditEventTypeDTO extends BaseDTO implements Serializable {
